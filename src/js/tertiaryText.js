 ...
 * tertiary_text.js
 *
 * By Michal Kowalkowski (kowalkowski.michal@gmail.com) with edits by Team Sprite
 */
...
var tertiaryText = function(titleText, callback) {
  ...
  var characters = [
    "ABC DEF GHI",
    "JKL M"+String.fromCharCode(160)+"N OPQ", // M & N need space between for clarity (nbsp)
    "RST UVW XYZ"
  ];
